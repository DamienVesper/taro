 ...
 */
let IgeViewport = IgeEntity.extend([
    ...
    viewArea: function () {
        let aabb = this.aabb();
        let camTrans = this.camera._translate;
        let camScale = this.camera._scale;
        let width = aabb.width * (1 / camScale.x);
        let height = aabb.height * (1 / camScale.y);
    ...
    paintAabbs: function (ctx, rootObject, index) {
        ...
        let ga;
        let r3d;
        let xl1; let xl2; let xl3; let xl4; let xl5; let xl6;
        let bf1; let bf2; let bf3; let bf4;
        let tf1; let tf2; let tf3; let tf4;
    ...
    _stringify: function () {
        ...
        let str = IgeEntity.prototype._stringify.call(this); let i;
