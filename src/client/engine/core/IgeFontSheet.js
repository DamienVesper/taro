 ...
 */
let IgeFontSheet = IgeTexture.extend({
            ...
            if (this.image) {
                ...
                try {
                    ...
                    if (this._fontData) {
                        ...
                        let header = this._fontData.font;
    ...
    _decode: function (canvas, x, y, maxX) {
        "use strict";
        let ctx = canvas.getContext(`2d`);
        let imageData = ctx.getImageData(x, y, maxX, canvas.height).data;
        let run = true;
        let quadCode;
        let i = 0;
        let jsonString = ``;
    ...
    measureTextWidth: function (text) {
        if (this._loaded) {
            let characterIndex;
            let charCodeMap = this._charCodeMap;
            let measuredWidthMap = this._measuredWidthMap;
            let charIndex;
            let lineArr = [];
            let lineIndex;
            let measuredWidth;
    ...
    render: function (ctx, entity) {
        if (entity._renderText && this._loaded) {
            ...
            let characterIndex;
            let charCodeMap = this._charCodeMap;
            let charPosMap = this._charPosMap;
            let measuredWidthMap = this._measuredWidthMap;
            let pixelWidthMap = this._pixelWidthMap;
            let renderX = 0;
            let renderY = 0;
            let renderStartX = 0;
            let renderStartY = 0;
