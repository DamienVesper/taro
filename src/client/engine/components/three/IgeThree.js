let IgeThree = IgeEventingClass.extend({
    classId: `IgeThree`,
    componentId: `three`,
    ...
    IgeCamera_tick: function (ctx) {
        ...
        if (this._trackTranslateTarget) {
            ...
            let targetX = targetEntity._translate.x; let // targetMatrix[2],
                targetY = targetEntity._translate.y; let // targetMatrix[5],
                sourceX; let sourceY; let distX; let distY;
        ...
        if (this._trackRotateTarget) {
            ...
            let targetZ = -(targetParentRZ + this._trackRotateTarget._rotate.z);
            let sourceZ; let distZ;
    ...
    IgeScene2d_init: function (options) {
        ...
        let ambient = new THREE.AmbientLight(0x242424);
        this._threeObj.add(ambient);

        let light = new THREE.SpotLight(0xd6e2ff, 1, 0, Math.PI, 1);
