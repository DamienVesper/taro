let IgeEntityManagerComponent = IgeClass.extend({
    ...
    currentArea: function () {
        ...
        let areaRect = this._areaRect;
        let areaCenter = this._areaCenter;
    ...
    _behaviour: function (ctx) {
        ...
        let mapData;
        let currentTile;
        let renderX; let renderY;
        let renderWidth; let renderHeight;
        let x; let y;
        let tileData;
        let renderSize;
        let ratio;
    ...
    processQueues: function () {
        ...
        let createLimit = this._maxCreatePerTick !== undefined ? this._maxCreatePerTick : 0;
        let createEntityFunc = this._createEntityFromMapData;
        let removeArr = this._removeArr;
        let removeCount = removeArr.length;
        let removeLimit = this._maxRemovePerTick !== undefined ? this._maxRemovePerTick : 0;
        let i;
    ...
    _resizeEvent: function (event) {
        ...
        if (this._areaRectAutoSize) {
            ...
            let additionX = 0; let additionY = 0;
