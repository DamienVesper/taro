let IgeTileMap2dSmartTexture = {
    render: function (ctx, entity) {
        let tileWidth = entity._tileWidth;
        let tileHeight = entity._tileHeight;
        let bounds2d = entity.bounds2d();
        let gridSize = entity._gridSize;
        let x = 0; let y = 0;
        ...
        if (entity._drawGrid) {
            ...
            let gridMaxY = y + tileHeight * gridSize.y;
            let index;
            let gStart;
            let gEnd;
        ...
        if (entity._drawMouse) {
            ...
            // Get mouse position
            let mousePos = ige._selectedViewport.mousePos();
            let mouseTile = entity.mouseToTile(ige._selectedViewport);
            var tilePoint;
            let text;
            let textMeasurement;
