 ...
 */
let IgeCamera = IgeEntity.extend({
    classId: `IgeCamera`,
    ...
    update: function (ctx) {
        ...
        if (this._trackTranslateTarget) {
            ...
            let targetMatrix = targetEntity._worldMatrix.matrix;
            let targetX = targetMatrix[2];
            let targetY = targetMatrix[5];
            let sourceX; let sourceY; let distX; let distY; let destinationX; let destinationY;
