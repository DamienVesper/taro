...
var IgePoint3d = IgeClass.extend({
	 ...
	 */
    toIso: function () {
        let sx = this.x - this.y;
        let sy = (-this.z) * 1.2247 + (this.x + this.y) * 0.5;
	 ...
	 */
    to2d: function () {
        let sx = this.y + this.x / 2;
        let sy = this.y - this.x / 2;
    ...
    interpolate: function (endPoint, startTime, currentTime, endTime) {
        let totalX = endPoint.x - this.x;
        let totalY = endPoint.y - this.y;
        let totalZ = endPoint.z - this.z;
        let totalTime = endTime - startTime;
        let deltaTime = totalTime - (currentTime - startTime);
        let timeRatio = deltaTime / totalTime;
