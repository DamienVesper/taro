 ...
 */
let IgeFontEntity = IgeUiEntity.extend({
    ...
    width: function (val, lockAspect, modifier, noUpdate) {
        ...
        let retVal = IgeUiEntity.prototype.width.call(this, val, lockAspect, modifier, noUpdate);
    ...
    nativeFont: function (val) {
        if (val !== undefined) {
            ...
            let tex = new IgeTexture(IgeFontSmartTexture);
            this.texture(tex);
    ...
    _stringify: function () {
        ...
        let str = IgeUiEntity.prototype._stringify.call(this); let i;
