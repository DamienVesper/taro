...
var IgePoly2d = IgeClass.extend({
    ...
    triangulate: function () {
        ...
        let poly = this._poly;
        let triangles = [];
        let indices = this.triangulationIndices();
        let i;
        let point1;
        let point2;
        let point3;
    ...
    _snip: function (u, v, w, n, V) {
        let p;
        let A = this._poly[V[u]];
        let B = this._poly[V[v]];
        let C = this._poly[V[w]];
        let P;
    ...
    render: function (ctx, fill) {
        let polyPoints = this._poly;
        let pointCount = polyPoints.length;
        let scaleX = this._scale.x;
        let scaleY = this._scale.y;
        let i;
