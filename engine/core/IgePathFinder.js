 ...
 */
let IgePathFinder = IgeEventingClass.extend({
    ...
    _getNeighbours: function (currentNode, endPoint, tileMap, comparisonCallback, allowSquare, allowDiagonal) {
        ...
        let newY = 0;
        let newNode;
        let mapData = tileMap.map._mapData;
        let currentNodeData = mapData[y] && mapData[y][x] ? mapData[y][x] : undefined;
        let tileData;
