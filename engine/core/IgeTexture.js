    ...
    render: function (ctx, entity) {
        ...
        if (entity._cell !== null) {
            ...
            if (this._mode === 0) {
                ...
                let cell = this._cells[entity._cell];
                let geom = entity._bounds2d;
                let poly = entity._renderPos; // Render pos is calculated in the IgeEntity.aabb() method
