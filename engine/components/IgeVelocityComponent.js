// TODO: Doc this class!
let IgeVelocityComponent = IgeClass.extend({
    ...
    byAngleAndPower: function (radians, power, relative) {
        ...
        let x = Math.cos(radians) * power;
        let y = Math.sin(radians) * power;
        let z = 0;
    ...
    linearForceVector3: function (vector, power, relative) {
        let force = this._linearForce = this._linearForce || new IgePoint3d(0, 0, 0);
        let x = vector.x / 1000;
        let y = vector.y / 1000;
        let z = vector.z / 1000;
