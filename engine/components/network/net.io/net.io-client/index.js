...
// Replace http:// with ws://
    ...
    _onDecode: function (packet, data) {
        ...
        let receivedBytes = (data.data && data.data.length) || 0;
        ...
        // average in last second
        let elapsed = (now - this._lastReceiveUpdated) * 0.001;
        if (elapsed >= 1) {
            ...
            let bandwidthUsed = (this._receivedBytesTotal + this._sentBytesTotal) / 1024;
    ...
    _decode: function (data) {
        ...
        let jsonString = LZString.decompressFromUTF16(data.data);
