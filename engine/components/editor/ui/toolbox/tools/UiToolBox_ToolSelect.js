let UiToolBox_ToolSelect = IgeEventingClass.extend({
    ...
    init: function () {
        ...
        ige.editor.on(`selectedObject`, (id) => {
        ...
        ige.editor.on(`mouseUp`, (event) => {
            if (event.button === 0) {
                ige.editor.ui.menus.closeAll();
            }

            if (event.button === 2 && ige.editor._selectedObject) {
                let classArr = ige.editor._selectedObjectClassList;
                let i;
