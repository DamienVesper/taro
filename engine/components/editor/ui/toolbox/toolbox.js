let UiToolBox = IgeEventingClass.extend({
    classId: `UiToolBox`,
    ...
    init: function () {
        ...
        // Load tool scripts
        ige.requireScript(`${igeRoot}components/editor/ui/toolbox/tools/UiToolBox_ToolCreate.js`, () => {
        ...
        ige.requireScript(`${igeRoot}components/editor/ui/toolbox/tools/UiToolBox_ToolTranslate.js`, () => {
            self.tools.UiToolBox_ToolTranslate = ige.newClassInstance(`UiToolBox_ToolTranslate`);
        });

        // Load the toolbox html into the editor DOM
        ige.editor.loadHtml(`${igeRoot}components/editor/ui/toolbox/toolbox.html`, (html) => {
            let toolbox = $(html);
    ...
    select: function (id) {
        let self = this;
        let elem = $(`#${id}`);
        let toolClassId = elem.attr(`data-tool`);
