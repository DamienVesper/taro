let IgeCannonComponent = IgeEventingClass.extend({
    ...
    createFloor: function (normalX, normalY, normalZ) {
        let groundShape = new CANNON.Plane(new CANNON.Vec3(normalX, normalY, normalZ));
        let groundBody = new CANNON.RigidBody(0, groundShape, this._slipperyMaterial);
    ...
    _behaviour: function (ctx) {
        let self = ige.cannon;
        let bodiesArr = self._world.bodies;
        let bodyCount = bodiesArr.length;
        let tempBod; let entity;
