...
let planck = (function (modules) {
    ...
    /******/ [
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let _DEBUG = false ? undefined : false;
            let _ASSERT = false ? undefined : false;

            module.exports = Vec2;

            let common = __webpack_require__(2);
            let Math = __webpack_require__(1);
            ...
            Vec2._deserialize = function (data) {
                let obj = Object.create(Vec2.prototype);
                obj.x = data.x;
                obj.y = data.y;
                return obj;
            };
            ...
            Vec2.prototype.clamp = function (max) {
                let lengthSqr = this.x * this.x + this.y * this.y;
                if (lengthSqr > max * max) {
                    let invLength = Math.invSqrt(lengthSqr);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let common = __webpack_require__(2);
            let create = __webpack_require__(6);
            let native = Math;
            let math = (module.exports = create(native));
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let common = __webpack_require__(2);
            let Vec2 = __webpack_require__(0);
            let Math = __webpack_require__(1);
            ...
            Rot.neo = function (angle) {
                let obj = Object.create(Rot.prototype);
                obj.setAngle(angle);
                return obj;
            };
            ...
            Rot.mulSub = function (rot, v, w) {
                let x = rot.c * (v.x - w.x) - rot.s * (v.y - w.y);
                let y = rot.s * (v.x - w.x) + rot.c * (v.y - w.y);
                return Vec2.neo(x, y);
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Transform.mul = function (a, b) {
                ...
                if (Array.isArray(b)) {
                    ...
                    _ASSERT && Vec2.assert(b);
                    let x = a.q.c * b.x - a.q.s * b.y + a.p.x;
                    let y = a.q.s * b.x + a.q.c * b.y + a.p.y;
                    return Vec2.neo(x, y);
            ...
            Transform.mulT = function (a, b) {
                ...
                if (`x` in b && `y` in b) {
                    ...
                    let px = b.x - a.p.x;
                    let py = b.y - a.p.y;
                    let x = a.q.c * px + a.q.s * py;
                    let y = -a.q.s * px + a.q.c * py;
                    return Vec2.neo(x, y);
                } else if (`p` in b && `q` in b) {
                    _ASSERT && Transform.assert(b);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let common = __webpack_require__(2);
            let options = __webpack_require__(7);

            let Vec2 = __webpack_require__(0);
            let Rot = __webpack_require__(3);
            let Math = __webpack_require__(1);
            let Sweep = __webpack_require__(9);
            let Transform = __webpack_require__(5);
            let Velocity = __webpack_require__(13);
            let Position = __webpack_require__(14);

            let Fixture = __webpack_require__(32);
            let Shape = __webpack_require__(16);

            let staticBody = (Body.STATIC = `static`);
            let kinematicBody = (Body.KINEMATIC = `kinematic`);
            let dynamicBody = (Body.DYNAMIC = `dynamic`);
            ...
            Body._deserialize = function (data, world, restore) {
                let body = new Body(world, data);

                data.fixtures.forEach((data) => {
                    let fixture = restore(Fixture, data, body);
            ...
            Body.prototype.setType = function (type) {
                ...
                let broadPhase = this.m_world.m_broadPhase;
                for (let f = this.m_fixtureList; f; f = f.m_next) {
            ...
            Body.prototype.getLinearVelocityFromWorldPoint = function (worldPoint) {
                let localCenter = Vec2.sub(worldPoint, this.m_sweep.c);
            ...
            Body.prototype.resetMassData = function () {
                ...
                // Move center of mass.
                let oldCenter = Vec2.clone(this.m_sweep.c);
 ...
 */
            Body.prototype.createFixture = function (shape, fixdef) {
                ...
                let fixture = new Fixture(this, shape, fixdef);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Sweep.prototype.setTransform = function (xf) {
                let c = Transform.mulVec2(xf, this.localCenter);
                this.c.set(c);
                this.c0.set(c);
            ...
            Sweep.prototype.normalize = function () {
                let a0 = Math.mod(this.a0, -Math.PI, +Math.PI);
                this.a -= this.a0 - a0;
                this.a0 = a0;
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Mat22.mul = function (mx, v) {
                if (v && `x` in v && `y` in v) {
                    _ASSERT && Vec2.assert(v);
                    let x = mx.ex.x * v.x + mx.ey.x * v.y;
                    let y = mx.ex.y * v.x + mx.ey.y * v.y;
                    return Vec2.neo(x, y);
                } else if (v && `ex` in v && `ey` in v) {
                    // Mat22
                    _ASSERT && Mat22.assert(v);
                    // return new Mat22(Vec2.mul(mx, v.ex), Vec2.mul(mx, v.ey));
                    let a = mx.ex.x * v.ex.x + mx.ey.x * v.ex.y;
                    let b = mx.ex.x * v.ey.x + mx.ey.x * v.ey.y;
                    let c = mx.ex.y * v.ex.x + mx.ey.y * v.ex.y;
                    let d = mx.ex.y * v.ey.x + mx.ey.y * v.ey.y;
            ...
            Mat22.mulT = function (mx, v) {
                if (v && `x` in v && `y` in v) {
                    ...
                    // Mat22
                    _ASSERT && Mat22.assert(v);
                    let c1 = Vec2.neo(Vec2.dot(mx.ex, v.ex), Vec2.dot(mx.ey, v.ex));
                    let c2 = Vec2.neo(Vec2.dot(mx.ex, v.ey), Vec2.dot(mx.ey, v.ey));
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Vec3._deserialize = function (data) {
                let obj = Object.create(Vec3.prototype);
                obj.x = data.x;
                obj.y = data.y;
                obj.z = data.z;
                return obj;
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Joint._deserialize = function (data, context, restore) {
                let clazz = Joint.TYPES[data.type];
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let Math = __webpack_require__(1);
            let Vec2 = __webpack_require__(0);
            let Vec3 = __webpack_require__(11);
            ...
            Mat33.mul = function (a, b) {
                ...
                if (b && `z` in b && `y` in b && `x` in b) {
                    ...
                    let z = a.ex.z * b.x + a.ey.z * b.y + a.ez.z * b.z;
                    return new Vec3(x, y, z);
            ...
            Mat33.mulVec3 = function (a, b) {
                _ASSERT && Mat33.assert(a);
                _ASSERT && Vec3.assert(b);
                let x = a.ex.x * b.x + a.ey.x * b.y + a.ez.x * b.z;
                let y = a.ex.y * b.x + a.ey.y * b.y + a.ez.y * b.z;
                let z = a.ex.z * b.x + a.ey.z * b.y + a.ez.z * b.z;
                return new Vec3(x, y, z);
            };
            ...
            Mat33.mulVec2 = function (a, b) {
                _ASSERT && Mat33.assert(a);
                _ASSERT && Vec2.assert(b);
                let x = a.ex.x * b.x + a.ey.x * b.y;
                let y = a.ex.y * b.x + a.ey.y * b.y;
                return Vec2.neo(x, y);
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Shape._deserialize = function (data, context, restore) {
                let clazz = Shape.TYPES[data.type];
                return clazz && restore(clazz, data);
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            AABB.isValid = function (aabb) {
                let d = Vec2.sub(aabb.upperBound, aabb.lowerBound);
                let valid = d.x >= 0.0 && d.y >= 0.0 && Vec2.isValid(aabb.lowerBound) && Vec2.isValid(aabb.upperBound);
                return valid;
            };
            ...
            AABB.prototype.combine = function (a, b) {
                ...
                let lowerA = a.lowerBound;
                let upperA = a.upperBound;
                let lowerB = b.lowerBound;
                let upperB = b.upperBound;

                let lowerX = Math.min(lowerA.x, lowerB.x);
                let lowerY = Math.min(lowerA.y, lowerB.y);
                let upperX = Math.max(upperB.x, upperA.x);
                let upperY = Math.max(upperB.y, upperA.y);
            ...
            AABB.testOverlap = function (a, b) {
                let d1x = b.lowerBound.x - a.upperBound.x;
                let d2x = a.lowerBound.x - b.upperBound.x;

                let d1y = b.lowerBound.y - a.upperBound.y;
                let d2y = a.lowerBound.y - b.upperBound.y;
            ...
            AABB.diff = function (a, b) {
                let wD = Math.max(0, Math.min(a.upperBound.x, b.upperBound.x) - Math.max(b.lowerBound.x, a.lowerBound.x));
                let hD = Math.max(0, Math.min(a.upperBound.y, b.upperBound.y) - Math.max(b.lowerBound.y, a.lowerBound.y));

                let wA = a.upperBound.x - a.lowerBound.x;
                let hA = a.upperBound.y - a.lowerBound.y;

                let wB = b.upperBound.x - b.lowerBound.x;
                let hB = b.upperBound.y - b.lowerBound.y;
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let Vec2 = __webpack_require__(0);
            let Transform = __webpack_require__(5);
            let Mat22 = __webpack_require__(10);
            let Rot = __webpack_require__(3);

            let Settings = __webpack_require__(4);
            let Manifold = __webpack_require__(19);
            let Distance = __webpack_require__(22);
            ...
            Contact.prototype.initConstraint = function (step) {
                let fixtureA = this.m_fixtureA;
                let fixtureB = this.m_fixtureB;
                ...
                for (let j = 0; j < pointCount; ++j) {
                    let cp = manifold.points[j]; // ManifoldPoint
                    let vcp = (this.v_points[j] = new VelocityConstraintPoint());
            ...
            Contact.prototype.update = function (listener) {
                ...
                if (sensor) {
                    ...
                    for (let i = 0; i < this.m_manifold.pointCount; ++i) {
                        let nmp = this.m_manifold.points[i];
                        nmp.normalImpulse = 0.0;
                        nmp.tangentImpulse = 0.0;

                        for (let j = 0; j < oldManifold.pointCount; ++j) {
                            let omp = oldManifold.points[j];
            ...
            Contact.prototype._solvePositionConstraint = function (step, toi, toiA, toiB) {
                ...
                let velocityA = bodyA.c_velocity;
                let velocityB = bodyB.c_velocity;
                let positionA = bodyA.c_position;
                let positionB = bodyB.c_position;

                let localCenterA = Vec2.clone(this.p_localCenterA);
                let localCenterB = Vec2.clone(this.p_localCenterB);
                ...
                let cA = Vec2.clone(positionA.c);
                let aA = positionA.a;

                let cB = Vec2.clone(positionB.c);
                let aB = positionB.a;
                ...
                for (let j = 0; j < this.p_pointCount; ++j) {
                    let xfA = Transform.identity();
                    let xfB = Transform.identity();
                    xfA.q.set(aA);
                    xfB.q.set(aB);
                    ...
                    let rA = Vec2.sub(point, cA);
                    let rB = Vec2.sub(point, cB);

                    // Track max constraint error.
                    minSeparation = Math.min(minSeparation, separation);

                    let baumgarte = toi ? Settings.toiBaugarte : Settings.baumgarte;
                    let linearSlop = Settings.linearSlop;
                    let maxLinearCorrection = Settings.maxLinearCorrection;

                    // Prevent large corrections and allow slop.
                    let C = Math.clamp(baumgarte * (separation + linearSlop), -maxLinearCorrection, 0.0);

                    // Compute the effective mass.
                    let rnA = Vec2.cross(rA, normal);
                    let rnB = Vec2.cross(rB, normal);
                    let K = mA + mB + iA * rnA * rnA + iB * rnB * rnB;

                    // Compute normal impulse
                    let impulse = K > 0.0 ? -C / K : 0.0;

                    let P = Vec2.mul(impulse, normal);
            ...
            Contact.prototype.initVelocityConstraint = function (step) {
                ...
                let radiusA = this.p_radiusA;
                let radiusB = this.p_radiusB;
                let manifold = this.getManifold();

                let mA = this.v_invMassA;
                let mB = this.v_invMassB;
                let iA = this.v_invIA;
                let iB = this.v_invIB;
                let localCenterA = Vec2.clone(this.p_localCenterA);
                let localCenterB = Vec2.clone(this.p_localCenterB);
                ...
                let cA = Vec2.clone(positionA.c);
                let aA = positionA.a;
                let vA = Vec2.clone(velocityA.v);
                let wA = velocityA.w;

                let cB = Vec2.clone(positionB.c);
                let aB = positionB.a;
                let vB = Vec2.clone(velocityB.v);
                let wB = velocityB.w;
                ...
                let worldManifold = manifold.getWorldManifold(null, xfA, radiusA, xfB, radiusB);

                this.v_normal.set(worldManifold.normal);

                for (let j = 0; j < this.v_pointCount; ++j) {
                    let vcp = this.v_points[j]; // VelocityConstraintPoint

                    vcp.rA.set(Vec2.sub(worldManifold.points[j], cA));
                    vcp.rB.set(Vec2.sub(worldManifold.points[j], cB));

                    let rnA = Vec2.cross(vcp.rA, this.v_normal);
                    let rnB = Vec2.cross(vcp.rB, this.v_normal);

                    let kNormal = mA + mB + iA * rnA * rnA + iB * rnB * rnB;

                    vcp.normalMass = kNormal > 0.0 ? 1.0 / kNormal : 0.0;

                    let tangent = Vec2.cross(this.v_normal, 1.0);

                    let rtA = Vec2.cross(vcp.rA, tangent);
                    let rtB = Vec2.cross(vcp.rB, tangent);
                    ...
                    vcp.velocityBias = 0.0;
                    let vRel = Vec2.dot(this.v_normal, vB) + Vec2.dot(this.v_normal, Vec2.cross(wB, vcp.rB)) - Vec2.dot(this.v_normal, vA) - Vec2.dot(this.v_normal, Vec2.cross(wA, vcp.rA));
                ...
                if (this.v_pointCount == 2 && step.blockSolve) {
                    let vcp1 = this.v_points[0]; // VelocityConstraintPoint
                    let vcp2 = this.v_points[1]; // VelocityConstraintPoint

                    let rn1A = Vec2.cross(vcp1.rA, this.v_normal);
                    let rn1B = Vec2.cross(vcp1.rB, this.v_normal);
                    let rn2A = Vec2.cross(vcp2.rA, this.v_normal);
                    let rn2B = Vec2.cross(vcp2.rB, this.v_normal);
            ...
            Contact.prototype.warmStartConstraint = function (step) {
                ...
                let normal = this.v_normal;
                let tangent = Vec2.cross(normal, 1.0);

                for (let j = 0; j < this.v_pointCount; ++j) {
                    let vcp = this.v_points[j]; // VelocityConstraintPoint

                    let P = Vec2.combine(vcp.normalImpulse, normal, vcp.tangentImpulse, tangent);
            ...
            Contact.prototype.solveVelocityConstraint = function (step) {
                ...
                for (let j = 0; j < this.v_pointCount; ++j) {
                    ...
                    let vt = Vec2.dot(dv, tangent) - this.v_tangentSpeed;
                ...
                if (this.v_pointCount == 1 || step.blockSolve == false) {
                    ...
                    let a = Vec2.neo(vcp1.normalImpulse, vcp2.normalImpulse);
                    ...
                    let b = Vec2.neo(vn1 - vcp1.velocityBias, vn2 - vcp2.velocityBias);
                    ...
                    for (;;) {
                        ...
                        // x = - inv(A) * b'
                        //
                        let x = Mat22.mulVec2(this.v_normalMass, b).neg();
                        ...
                        if (x.x >= 0.0 && vn2 >= 0.0) {
                            ...
                            if (DEBUG_SOLVER) {
                                // Postconditions
                                let dv1B = Vec2.add(vB, Vec2.cross(wB, vcp1.rB));
                                let dv1A = Vec2.add(vA, Vec2.cross(wA, vcp1.rA));
                        ...
                        if (x.y >= 0.0 && vn1 >= 0.0) {
                            ...
                            if (DEBUG_SOLVER) {
                                // Postconditions
                                let dv2B = Vec2.add(vB, Vec2.cross(wB, vcp2.rB));
                                let dv2A = Vec2.add(vA, Vec2.cross(wA, vcp2.rA));
            ...
            Contact.create = function (fixtureA, indexA, fixtureB, indexB) {
                let typeA = fixtureA.getType(); // Shape.Type
                let typeB = fixtureB.getType(); // Shape.Type

                // TODO: pool contacts
                let contact, evaluateFcn;
            ...
            Contact.destroy = function (contact, listener) {
                ...
                let destroyFcn = s_registers[typeA][typeB].destroyFcn;
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Manifold.prototype.getWorldManifold = function (wm, xfA, radiusA, xfB, radiusB) {
                ...
                let points = wm.points;
                let separations = wm.separations;
        ...
        /* 20 */ /***/ function (module, exports, __webpack_require__) {
            ...
            let Rot = __webpack_require__(3);
            let Vec2 = __webpack_require__(0);
            let AABB = __webpack_require__(17);
            let Settings = __webpack_require__(4);
            let Shape = __webpack_require__(16);
            ...
            PolygonShape._deserialize = function (data, fixture, restore) {
                let vertices = data.vertices && data.vertices.map(v => Vec2._deserialize(v));
            ...
            function ComputeCentroid (vs, count) {
                ...
                for (var i = 0; i < count; ++i) {
                    ...
                    let e1 = Vec2.sub(p2, p1);
                    let e2 = Vec2.sub(p3, p1);

                    let D = Vec2.cross(e1, e2);
            ...
            PolygonShape.prototype._set = function (vertices) {
                ...
                let ps = []; // [Settings.maxPolygonVertices];
                for (var i = 0; i < n; ++i) {
                    var v = vertices[i];
                ...
                let hull = []; // [Settings.maxPolygonVertices];
                let m = 0;
                let ih = i0;
                ...
                for (;;) {
                    ...
                    for (var j = 1; j < n; ++j) {
                        ...
                        let r = Vec2.sub(ps[ie], ps[hull[m]]);
                        var v = Vec2.sub(ps[j], ps[hull[m]]);
                        let c = Vec2.cross(r, v);
                ...
                for (var i = 0; i < m; ++i) {
                    let i1 = i;
                    let i2 = i + 1 < m ? i + 1 : 0;
                    let edge = Vec2.sub(this.m_vertices[i2], this.m_vertices[i1]);
            ...
            PolygonShape.prototype.testPoint = function (xf, p) {
                let pLocal = Rot.mulTVec2(xf.q, Vec2.sub(p, xf.p));

                for (let i = 0; i < this.m_count; ++i) {
                    let dot = Vec2.dot(this.m_normals[i], Vec2.sub(pLocal, this.m_vertices[i]));
                    if (dot > 0.0) {
                        return false;
                    }
                }
            ...
            PolygonShape.prototype.rayCast = function (output, input, xf, childIndex) {
                ...
                let p1 = Rot.mulTVec2(xf.q, Vec2.sub(input.p1, xf.p));
                let p2 = Rot.mulTVec2(xf.q, Vec2.sub(input.p2, xf.p));
                let d = Vec2.sub(p2, p1);
                ...
                for (let i = 0; i < this.m_count; ++i) {
                    ...
                    let numerator = Vec2.dot(this.m_normals[i], Vec2.sub(this.m_vertices[i], p1));
                    let denominator = Vec2.dot(this.m_normals[i], d);
            ...
            PolygonShape.prototype.computeAABB = function (aabb, xf, childIndex) {
                ...
                let maxY = -Infinity;
                for (let i = 0; i < this.m_count; ++i) {
                    let v = Transform.mulVec2(xf, this.m_vertices[i]);
            ...
            PolygonShape.prototype.computeMass = function (massData, density) {
                ...
                for (var i = 0; i < this.m_count; ++i) {
                    // Triangle vertices.
                    let e1 = Vec2.sub(this.m_vertices[i], s);
                    let e2 = i + 1 < this.m_count ? Vec2.sub(this.m_vertices[i + 1], s) : Vec2.sub(this.m_vertices[0], s);
            ...
            PolygonShape.prototype.validate = function () {
                for (let i = 0; i < this.m_count; ++i) {
                    ...
                    let e = Vec2.sub(this.m_vertices[i2], p);
                    ...
                    for (let j = 0; j < this.m_count; ++j) {
                        ...
                        let v = Vec2.sub(this.m_vertices[j], p);
                        let c = Vec2.cross(e, v);
                        if (c < 0.0) {
                            return false;
                        }
                    }
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let stats = __webpack_require__(27);

            let Math = __webpack_require__(1);
            let Vec2 = __webpack_require__(0);
            let Vec3 = __webpack_require__(11);
            let Mat22 = __webpack_require__(10);
            let Mat33 = __webpack_require__(15);
            let Rot = __webpack_require__(3);
            let Sweep = __webpack_require__(9);
            let Transform = __webpack_require__(5);
            let Velocity = __webpack_require__(13);
            ...
            function Distance (output, cache, input) {
                ...
                let xfA = input.transformA;
                let xfB = input.transformB;
                ...
                let vertices = simplex.m_v; // SimplexVertex
                let k_maxIters = Settings.maxDistnceIterations;
                ...
                while (iter < k_maxIters) {
                    ...
                    let vertex = vertices[simplex.m_count]; // SimplexVertex
                ...
                if (input.useRadii) {
                    ...
                    if (output.distance > rA + rB && output.distance > Math.EPSILON) {
                        ...
                        let normal = Vec2.sub(output.pointB, output.pointA);
                        normal.normalize();
            ...
            DistanceProxy.prototype.getSupport = function (d) {
                ...
                for (let i = 0; i < this.m_count; ++i) {
                    let value = Vec2.dot(this.m_vertices[i], d);
                    if (value > bestValue) {
                        bestIndex = i;
                        bestValue = value;
                    }
            ...
            Simplex.prototype.getSearchDirection = function () {
                switch (this.m_count) {
                    ...
                    case 2: {
                        let e12 = Vec2.sub(this.m_v2.w, this.m_v1.w);
                        let sgn = Vec2.cross(e12, Vec2.neg(this.m_v1.w));
                        if (sgn > 0.0) {
            ...
            Simplex.prototype.solve3 = function () {
                ...
                // Triangle123
                let n123 = Vec2.cross(e12, e13);

                let d123_1 = n123 * Vec2.cross(w2, w3);
                let d123_2 = n123 * Vec2.cross(w3, w1);
                let d123_3 = n123 * Vec2.cross(w1, w2);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            CircleShape.prototype.testPoint = function (xf, p) {
                let center = Vec2.add(xf.p, Rot.mulVec2(xf.q, this.m_p));
                let d = Vec2.sub(p, center);
            ...
            CircleShape.prototype.rayCast = function (output, input, xf, childIndex) {
                let position = Vec2.add(xf.p, Rot.mulVec2(xf.q, this.m_p));
                let s = Vec2.sub(input.p1, position);
                let b = Vec2.dot(s, s) - this.m_radius * this.m_radius;

                // Solve quadratic equation.
                let r = Vec2.sub(input.p2, input.p1);
                let c = Vec2.dot(s, r);
                let rr = Vec2.dot(r, r);
                let sigma = c * c - rr * b;
            ...
            CircleShape.prototype.computeAABB = function (aabb, xf, childIndex) {
                let p = Vec2.add(xf.p, Rot.mulVec2(xf.q, this.m_p));
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            EdgeShape._deserialize = function (data) {
                let shape = new EdgeShape(data.vertex1, data.vertex2);
                if (shape.hasVertex0) {
            ...
            EdgeShape.prototype.rayCast = function (output, input, xf, childIndex) {
                ...
                let e = Vec2.sub(v2, v1);
                let normal = Vec2.neo(e.y, -e.x);
                normal.normalize();

                // q = p1 + t * d
                // dot(normal, q - v1) = 0
                // dot(normal, p1 - v1) + t * dot(normal, d) = 0
                let numerator = Vec2.dot(normal, Vec2.sub(v1, p1));
                ...
                let q = Vec2.add(p1, Vec2.mul(t, d));

                // q = v1 + s * r
                // s = dot(q - v1, r) / dot(r, r)
                let r = Vec2.sub(v2, v1);
                let rr = Vec2.dot(r, r);
                if (rr == 0.0) {
                    return false;
                }

                let s = Vec2.dot(Vec2.sub(q, v1), r) / rr;
                if (s < 0.0 || s > 1.0) {
                    return false;
                }
            ...
            EdgeShape.prototype.computeAABB = function (aabb, xf, childIndex) {
                let v1 = Transform.mulVec2(xf, this.m_vertex1);
                let v2 = Transform.mulVec2(xf, this.m_vertex2);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let Settings = __webpack_require__(4);
            let Shape = __webpack_require__(16);
            let EdgeShape = __webpack_require__(24);
            ...
            ChainShape._deserialize = function (data) {
                let shape = new ChainShape(data.vertices.map(Vec2._deserialize), data.isLoop);
                if (data.prevVertex) {
            ...
            ChainShape.prototype.rayCast = function (output, input, xf, childIndex) {
                ...
                let edgeShape = new EdgeShape(this.getVertex(childIndex), this.getVertex(childIndex + 1));
            ...
            ChainShape.prototype.computeAABB = function (aabb, xf, childIndex) {
                ...
                let v1 = Transform.mulVec2(xf, this.getVertex(childIndex));
                let v2 = Transform.mulVec2(xf, this.getVertex(childIndex + 1));
        ...
        /* 29 */ /***/ function (module, exports, __webpack_require__) {
            ...
            let common = __webpack_require__(2);
            let Vec2 = __webpack_require__(0);
            let BroadPhase = __webpack_require__(41);
            let Solver = __webpack_require__(43);
            let Body = __webpack_require__(8);
            let Joint = __webpack_require__(12);
            let Contact = __webpack_require__(18);
            ...
            World._deserialize = function (data, context, restore) {
                ...
                let world = new World(data.gravity);

                data.bodies &&
                    data.bodies.reverse().forEach((data) => {
                        world._addBody(restore(Body, data, world));
                    });

                data.joints &&
                    data.joints.reverse().forEach((data) => {
            ...
            World.prototype.queryAABB = function (aabb, queryCallback) {
                ...
                let broadPhase = this.m_broadPhase;
                this.m_broadPhase.query(aabb, (proxyId) => {
                    // TODO GC
                    let proxy = broadPhase.getUserData(proxyId); // FixtureProxy
                ...
                this.m_broadPhase.rayCast(
                    ...
                    (input, proxyId) => {
                        ...
                        if (hit) {
                            ...
                            let point = Vec2.add(Vec2.mul(1.0 - fraction, input.p1), Vec2.mul(fraction, input.p2));
            ...
            World.prototype.destroyJoint = function (joint) {
                ...
                let bodyA = joint.m_bodyA;
                let bodyB = joint.m_bodyB;
            ...
            let s_step = new Solver.TimeStep(); // reuse
            ...
            World.prototype.createContact = function (proxyA, proxyB) {
                ...
                // Call the factory.
                let contact = Contact.create(fixtureA, indexA, fixtureB, indexB);
                if (contact == null) {
                    return;
                }
            ...
            World.prototype.updateContacts = function () {
                ...
                while ((c = next_c)) {
                    ...
                    let activeA = bodyA.isAwake() && !bodyA.isStatic();
                    let activeB = bodyB.isAwake() && !bodyB.isStatic();
            ...
            World.prototype.off = function (name, listener) {
                ...
                let listeners = this._listeners && this._listeners[name];
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let Settings = __webpack_require__(4);
            let common = __webpack_require__(2);
            let Pool = __webpack_require__(42);
            let Vec2 = __webpack_require__(0);
            let Math = __webpack_require__(1);
            let AABB = __webpack_require__(17);
            ...
            DynamicTree.prototype.insertLeaf = function (leaf) {
                ...
                while (index.isLeaf() == false) {
                    ...
                    let area = index.aabb.getPerimeter();
            ...
            DynamicTree.prototype.removeLeaf = function (leaf) {
                ...
                if (grandParent != null) {
                    ...
                    while (index != null) {
                        ...
                        let child1 = index.child1;
                        let child2 = index.child2;
            ...
            DynamicTree.prototype.getAreaRatio = function () {
                ...
                let totalArea = 0.0;
                let node;
                let it = iteratorPool.allocate().preorder(this.m_root);
                while ((node = it.next())) {
                    if (node.height < 0) {
                        // Free node in pool
                        continue;
            ...
            DynamicTree.prototype.computeHeight = function (id) {
                ...
                let height1 = this.computeHeight(node.child1.id);
                let height2 = this.computeHeight(node.child2.id);
            ...
            DynamicTree.prototype.validateMetrics = function (node) {
                ...
                let height1 = child1.height;
                let height2 = child2.height;
            ...
            DynamicTree.prototype.getMaxBalance = function () {
                ...
                while ((node = it.next())) {
                    ...
                    let balance = Math.abs(node.child2.height - node.child1.height);
            ...
            DynamicTree.prototype.rebuildBottomUp = function () {
                ...
                while (count > 1) {
                    ...
                    for (let i = 0; i < count; ++i) {
                        let aabbi = nodes[i].aabb;
                        for (let j = i + 1; j < count; ++j) {
                            let aabbj = nodes[j].aabb;
                            let b = new AABB();
                    ...
                    let child1 = nodes[iMin];
                    let child2 = nodes[jMin];

                    let parent = this.allocateNode();
            ...
            DynamicTree.prototype.query = function (aabb, queryCallback) {
                ...
                while (stack.length > 0) {
                    ...
                    if (AABB.testOverlap(node.aabb, aabb)) {
                        if (node.isLeaf()) {
                            let proceed = queryCallback(node.id);
                            if (proceed == false) {
                                return;
                            }
                        } else {
            ...
            DynamicTree.prototype.rayCast = function (input, rayCastCallback) {
                ...
                let p1 = input.p1;
                let p2 = input.p2;
                let r = Vec2.sub(p2, p1);
                _ASSERT && common.assert(r.lengthSquared() > 0.0);
                r.normalize();

                // v is perpendicular to the segment.
                let v = Vec2.cross(1.0, r);
                let abs_v = Vec2.abs(v);
                ...
                while (stack.length > 0) {
                    ...
                    let separation = Math.abs(Vec2.dot(v, Vec2.sub(p1, c))) - Vec2.dot(abs_v, h);
                    if (separation > 0.0) {
                        continue;
                    }
                    ...
                    if (node.isLeaf()) {
                        ...
                        let value = rayCastCallback(subInput, node.id);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Fixture.prototype._reset = function () {
                ...
                let broadPhase = body.m_world.m_broadPhase;
            ...
            Fixture._deserialize = function (data, body, restore) {
                let shape = restore(Shape, data.shape);
                let fixture = shape && new Fixture(body, shape, data);
                return fixture;
            };
            ...
            Fixture.prototype.synchronize = function (broadPhase, xf1, xf2) {
                for (let i = 0; i < this.m_proxyCount; ++i) {
                    ...
                    let displacement = Vec2.sub(xf2.p, xf1.p);
            ...
            Fixture.prototype.refilter = function () {
                ...
                let broadPhase = world.m_broadPhase;
                for (let i = 0; i < this.m_proxyCount; ++i) {
            ...
            Fixture.prototype.shouldCollide = function (that) {
                ...
                let collide = (that.m_filterMaskBits & this.m_filterCategoryBits) != 0 && (that.m_filterCategoryBits & this.m_filterMaskBits) != 0;
                return collide;
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let common = __webpack_require__(2);
            let Timer = __webpack_require__(44);
            ...
            let DistanceProxy = Distance.Proxy;
            ...
            function TimeOfImpact (output, input) {
                ...
                let proxyA = input.proxyA; // DistanceProxy
                let proxyB = input.proxyB; // DistanceProxy

                let sweepA = input.sweepA; // Sweep
                let sweepB = input.sweepB; // Sweep
                ...
                let target = Math.max(Settings.linearSlop, totalRadius - 3.0 * Settings.linearSlop);
                let tolerance = 0.25 * Settings.linearSlop;
                _ASSERT && common.assert(target > tolerance);

                let t1 = 0.0;
                let k_maxIterations = Settings.maxTOIIterations;
                let iter = 0;

                // Prepare input for distance query.
                let cache = new SimplexCache();

                let distanceInput = new DistanceInput();
                ...
                for (;;) {
                    ...
                    let distanceOutput = new DistanceOutput();
                    ...
                    let fcn = new SeparationFunction();
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            RevoluteJoint._deserialize = function (data, world, restore) {
                ...
                let joint = new RevoluteJoint(data);
                return joint;
            };
            ...
            RevoluteJoint.prototype.initVelocityConstraints = function (step) {
                ...
                let vA = this.m_bodyA.c_velocity.v;
                let wA = this.m_bodyA.c_velocity.w;

                let aB = this.m_bodyB.c_position.a;
                let vB = this.m_bodyB.c_velocity.v;
                ...
                let mB = this.m_invMassB; // float
                let iA = this.m_invIA;
                let iB = this.m_invIB; // float

                let fixedRotation = iA + iB === 0.0; // bool
                ...
                if (this.m_enableLimit && fixedRotation == false) {
                    let jointAngle = aB - aA - this.m_referenceAngle; // float
                ...
                if (step.warmStarting) {
                    ...
                    let P = Vec2.neo(this.m_impulse.x, this.m_impulse.y);
            ...
            RevoluteJoint.prototype.solveVelocityConstraints = function (step) {
                ...
                if (this.m_enableLimit && this.m_limitState != inactiveLimit && fixedRotation == false) {
                    ...
                    let P = Vec2.neo(impulse.x, impulse.y);
            ...
            RevoluteJoint.prototype.solvePositionConstraints = function (step) {
                let cA = this.m_bodyA.c_position.c;
                let aA = this.m_bodyA.c_position.a;
                let cB = this.m_bodyB.c_position.c;
                let aB = this.m_bodyB.c_position.a;
                ...
                let fixedRotation = this.m_invIA + this.m_invIB == 0.0; // bool

                // Solve angular limit constraint.
                if (this.m_enableLimit && this.m_limitState != inactiveLimit && fixedRotation == false) {
                    let angle = aB - aA - this.m_referenceAngle; // float
                ...
                // Solve point-to-point constraint.
                {
                    qA.set(aA);
                    qB.set(aB);
                    let rA = Rot.mulVec2(qA, Vec2.sub(this.m_localAnchorA, this.m_localCenterA)); // Vec2
                    let rB = Rot.mulVec2(qB, Vec2.sub(this.m_localAnchorB, this.m_localCenterB)); // Vec2
                    ...
                    let impulse = Vec2.neg(K.solve(C)); // Vec2
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            PrismaticJoint._deserialize = function (data, world, restore) {
                ...
                let joint = new PrismaticJoint(data);
                return joint;
            };
            ...
            PrismaticJoint.prototype.getJointSpeed = function () {
                ...
                let rA = Rot.mulVec2(bA.m_xf.q, Vec2.sub(this.m_localAnchorA, bA.m_sweep.localCenter)); // Vec2
                let rB = Rot.mulVec2(bB.m_xf.q, Vec2.sub(this.m_localAnchorB, bB.m_sweep.localCenter)); // Vec2
                let p1 = Vec2.add(bA.m_sweep.c, rA); // Vec2
                let p2 = Vec2.add(bB.m_sweep.c, rB); // Vec2
                let d = Vec2.sub(p2, p1); // Vec2
                let axis = Rot.mulVec2(bA.m_xf.q, this.m_localXAxisA); // Vec2

                let vA = bA.m_linearVelocity; // Vec2
                let vB = bB.m_linearVelocity; // Vec2
                let wA = bA.m_angularVelocity; // float
                let wB = bB.m_angularVelocity; // float

                let speed = Vec2.dot(d, Vec2.cross(wA, axis)) + Vec2.dot(axis, Vec2.sub(Vec2.addCross(vB, wB, rB), Vec2.addCross(vA, wA, rA))); // float
                return speed;
            };
            ...
            PrismaticJoint.prototype.initVelocityConstraints = function (step) {
                ...
                let rA = Rot.mulVec2(qA, Vec2.sub(this.m_localAnchorA, this.m_localCenterA));
                let rB = Rot.mulVec2(qB, Vec2.sub(this.m_localAnchorB, this.m_localCenterB));
                let d = Vec2.zero();
                d.addCombine(1, cB, 1, rB);
                d.subCombine(1, cA, 1, rA);

                let mA = this.m_invMassA;
                let mB = this.m_invMassB;
                let iA = this.m_invIA;
                let iB = this.m_invIB;
                ...
                // Prismatic constraint.
                {
                    ...
                    let s1test = Vec2.cross(rA, this.m_perp);
                ...
                if (this.m_enableLimit) {
                    let jointTranslation = Vec2.dot(this.m_axis, d); // float
                ...
                if (step.warmStarting) {
                    ...
                    let P = Vec2.combine(this.m_impulse.x, this.m_perp, this.m_motorImpulse + this.m_impulse.z, this.m_axis);
            ...
            PrismaticJoint.prototype.solveVelocityConstraints = function (step) {
                ...
                if (this.m_enableLimit && this.m_limitState != inactiveLimit) {
                    ...
                    // f2(1:2) = invK(1:2,1:2) * (-Cdot(1:2) - K(1:2,3) * (f2(3) - f1(3))) +
                    // f1(1:2)
                    let b = Vec2.combine(-1, Cdot1, -(this.m_impulse.z - f1.z), Vec2.neo(this.m_K.ez.x, this.m_K.ez.y)); // Vec2
                    let f2r = Vec2.add(this.m_K.solve22(b), Vec2.neo(f1.x, f1.y)); // Vec2
            ...
            PrismaticJoint.prototype.solvePositionConstraints = function (step) {
                ...
                let rA = Rot.mulVec2(qA, Vec2.sub(this.m_localAnchorA, this.m_localCenterA)); // Vec2
                let rB = Rot.mulVec2(qB, Vec2.sub(this.m_localAnchorB, this.m_localCenterB)); // Vec2
                let d = Vec2.sub(Vec2.add(cB, rB), Vec2.add(cA, rA)); // Vec2

                let axis = Rot.mulVec2(qA, this.m_localXAxisA); // Vec2
                let a1 = Vec2.cross(Vec2.add(d, rA), axis); // float
                let a2 = Vec2.cross(rB, axis); // float
                let perp = Rot.mulVec2(qA, this.m_localYAxisA); // Vec2

                let s1 = Vec2.cross(Vec2.add(d, rA), perp); // float
                let s2 = Vec2.cross(rB, perp); // float

                let impulse = Vec3();
                let C1 = Vec2.zero(); // Vec2
                C1.x = Vec2.dot(perp, d);
                C1.y = aB - aA - this.m_referenceAngle;

                let linearError = Math.abs(C1.x); // float
                let angularError = Math.abs(C1.y); // float
                ...
                let C2 = 0.0; // float
                if (this.m_enableLimit) {
                    let translation = Vec2.dot(axis, d); // float
                ...
                if (active) {
                    ...
                    let k13 = iA * s1 * a1 + iB * s2 * a2; // float
                    var k22 = iA + iB; // float
                    if (k22 == 0.0) {
                        // For fixed rotation
                        k22 = 1.0;
                    }
                    let k23 = iA * a1 + iB * a2; // float
                    let k33 = mA + mB + iA * a1 * a1 + iB * a2 * a2; // float
                    ...
                    let impulse1 = K.solve(Vec2.neg(C1)); // Vec2
                    impulse.x = impulse1.x;
                    impulse.y = impulse1.y;
                    impulse.z = 0.0;
                }

                let P = Vec2.combine(impulse.x, perp, impulse.z, axis); // Vec2
                let LA = impulse.x * s1 + impulse.y + impulse.z * a1; // float
                let LB = impulse.x * s2 + impulse.y + impulse.z * a2; // float
        ...
        /* 40 */
        /***/ function (module, exports, __webpack_require__) {
            let World = __webpack_require__(30);
            let Body = __webpack_require__(8);
            let Joint = __webpack_require__(12);
            let Shape = __webpack_require__(16);
            ...
            function Serializer (opts) {
                ...
                let stringify = opts.stringify || JSON.stringify;
                let parse = opts.parse || JSON.parse;

                let rootClass = opts.rootClass || World;
                ...
                this.toJson = function (root) {
                    ...
                    function storeRef (value, typeName) {
                        ...
                        if (!refMap[value.__sid]) {
                            queue.push(value);
                            let index = flat.length + queue.length;
                            let ref = {
                                refIndex: index,
                                refType: typeName
                            };
                    ...
                    let result = `[${flat.join(`,`)}]`;
                    return result;
                };

                this.fromJson = function (string) {
                    let flat = parse(string);
                    let refMap = {};
                    ...
                    function restoreRef (cls, ref, ctx) {
                        ...
                        let index = ref.refIndex;
                        if (!refMap[index]) {
                            let data = flat[index];
                            let obj = deserialize(cls, data, ctx);
                            refMap[index] = obj;
                        }
                        return refMap[index];
                    }

                    let root = rootClass._deserialize(flat[0], null, restoreRef);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let Math = __webpack_require__(1);
            let AABB = __webpack_require__(17);
            let DynamicTree = __webpack_require__(31);
            ...
            BroadPhase.prototype.moveProxy = function (proxyId, aabb, displacement) {
                _ASSERT && common.assert(AABB.isValid(aabb));
                let changed = this.m_tree.moveProxy(proxyId, aabb, displacement);
                if (changed) {
                    this.bufferMove(proxyId);
                }
            };
            ...
            BroadPhase.prototype.queryCallback = function (proxyId) {
                ...
                let proxyIdA = Math.min(proxyId, this.m_queryProxyId);
                let proxyIdB = Math.max(proxyId, this.m_queryProxyId);

                // TODO: Skip any duplicate pairs.

                let userDataA = this.m_tree.getUserData(proxyIdA);
                let userDataB = this.m_tree.getUserData(proxyIdB);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function Pool (opts) {
                let _list = [];
                let _max = opts.max || Infinity;

                let _createFn = opts.create;
                let _outFn = opts.allocate;
                let _inFn = opts.release;
                let _discardFn = opts.discard;
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let TimeOfImpact = __webpack_require__(33);
            let TOIInput = TimeOfImpact.Input;
            let TOIOutput = TimeOfImpact.Output;
            ...
            Solver.prototype.solveIsland = function (step) {
                ...
                let allowSleep = world.m_allowSleep;
                ...
                for (var i = 0; i < step.positionIterations; ++i) {
                    ...
                    for (var j = 0; j < this.m_contacts.length; ++j) {
                        var contact = this.m_contacts[j];
                        let separation = contact.solvePositionConstraint(step);
                        minSeparation = Math.min(minSeparation, separation);
                    }
                    // We can't expect minSpeparation >= -Settings.linearSlop because we don't
                    // push the separation above -Settings.linearSlop.
                    let contactsOkay = minSeparation >= -3.0 * Settings.linearSlop;

                    let jointsOkay = true;
                    for (var j = 0; j < this.m_joints.length; ++j) {
                        var joint = this.m_joints[j];
                        let jointOkay = joint.solvePositionConstraints(step);
                ...
                if (allowSleep) {
                    ...
                    let linTolSqr = Settings.linearSleepToleranceSqr;
                    let angTolSqr = Settings.angularSleepToleranceSqr;
            ...
            let s_subStep = new TimeStep(); // reuse
                ...
                for (;;) {
                    ...
                    for (var c = world.m_contactList; c; c = c.m_next) {
                        ...
                        if (c.m_toiFlag) {
                            ...
                            let activeA = bA.isAwake() && !bA.isStatic();
                            let activeB = bB.isAwake() && !bB.isStatic();
                            ...
                            let collideA = bA.isBullet() || !bA.isDynamic();
                            let collideB = bB.isBullet() || !bB.isDynamic();
                            ...
                            let sweepA = bA.m_sweep;
                            let sweepB = bB.m_sweep;

                            // Compute the time of impact in interval [0, minTOI]
                            let input = new TOIInput(); // TODO: reuse
                            ...
                            let output = new TOIOutput(); // TODO: reuse
                    ...
                    let backup1 = bA.m_sweep.clone();
                    let backup2 = bB.m_sweep.clone();
                    ...
                    for (var i = 0; i < bodies.length; ++i) {
                        ...
                        if (body.isDynamic()) {
                            for (var ce = body.m_contactList; ce; ce = ce.next) {
                                ...
                                let backup = other.m_sweep.clone();
            ...
            Solver.prototype.solveIslandTOI = function (subStep, toiA, toiB) {
                ...
                for (var i = 0; i < subStep.positionIterations; ++i) {
                    ...
                    for (var j = 0; j < this.m_contacts.length; ++j) {
                        var contact = this.m_contacts[j];
                        let separation = contact.solvePositionConstraintTOI(subStep, toiA, toiB);
                        minSeparation = Math.min(minSeparation, separation);
                    }
                    // We can't expect minSpeparation >= -Settings.linearSlop because we don't
                    // push the separation above -Settings.linearSlop.
                    let contactsOkay = minSeparation >= -1.5 * Settings.linearSlop;
                    if (contactsOkay) {
                        break;
                    }
                }
                ...
                for (var i = 0; i < this.m_bodies.length; ++i) {
                    ...
                    let v = Vec2.clone(body.c_velocity.v);
            ...
            Solver.prototype.postSolveIsland = function () {
                ...
                let impulse = new ContactImpulse();
                for (let c = 0; c < this.m_contacts.length; ++c) {
                    let contact = this.m_contacts[c];
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let common = __webpack_require__(2);
            let create = __webpack_require__(6);
            let PolygonShape = __webpack_require__(21);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let Contact = __webpack_require__(18);
            let Manifold = __webpack_require__(19);
            let CircleShape = __webpack_require__(23);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let Manifold = __webpack_require__(19);
            let EdgeShape = __webpack_require__(24);
            let ChainShape = __webpack_require__(28);
            let CircleShape = __webpack_require__(23);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function CollidePolygons (manifold, polyA, xfA, polyB, xfB) {
                ...
                let incidentEdge = [new Manifold.clipVertex(), new Manifold.clipVertex()];
                ...
                let clipPoints1 = [new Manifold.clipVertex(), new Manifold.clipVertex()];
                let clipPoints2 = [new Manifold.clipVertex(), new Manifold.clipVertex()];
                let np;
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function CollideEdgePolygon (manifold, edgeA, xfA, polygonB, xfB) {
                ...
                let ie = [new Manifold.clipVertex(), new Manifold.clipVertex()];
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            DistanceJoint._deserialize = function (data, world, restore) {
                data.bodyA = restore(Body, data.bodyA, world);
                data.bodyB = restore(Body, data.bodyB, world);
                let joint = new DistanceJoint(data);
                return joint;
            };
            ...
            DistanceJoint.prototype.initVelocityConstraints = function (step) {
                ...
                let crAu = Vec2.cross(this.m_rA, this.m_u);
                let crBu = Vec2.cross(this.m_rB, this.m_u);
                ...
                if (step.warmStarting) {
                    ...
                    let P = Vec2.mul(this.m_impulse, this.m_u);
            ...
            DistanceJoint.prototype.solveVelocityConstraints = function (step) {
                ...
                let vpA = Vec2.add(vA, Vec2.cross(wA, this.m_rA));
                let vpB = Vec2.add(vB, Vec2.cross(wB, this.m_rB));
                let Cdot = Vec2.dot(this.m_u, vpB) - Vec2.dot(this.m_u, vpA);

                let impulse = -this.m_mass * (Cdot + this.m_bias + this.m_gamma * this.m_impulse);
                this.m_impulse += impulse;

                let P = Vec2.mul(impulse, this.m_u);
                vA.subMul(this.m_invMassA, P);
                wA -= this.m_invIA * Vec2.cross(this.m_rA, P);
                vB.addMul(this.m_invMassB, P);
                wB += this.m_invIB * Vec2.cross(this.m_rB, P);
            ...
            DistanceJoint.prototype.solvePositionConstraints = function (step) {
                ...
                let rA = Rot.mulSub(qA, this.m_localAnchorA, this.m_localCenterA);
                let rB = Rot.mulSub(qB, this.m_localAnchorB, this.m_localCenterB);
                let u = Vec2.sub(Vec2.add(cB, rB), Vec2.add(cA, rA));
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            FrictionJoint._deserialize = function (data, world, restore) {
                data.bodyA = restore(Body, data.bodyA, world);
                data.bodyB = restore(Body, data.bodyB, world);
                let joint = new FrictionJoint(data);
                return joint;
            };
            ...
            FrictionJoint.prototype.initVelocityConstraints = function (step) {
                ...
                if (step.warmStarting) {
                    ...
                    let P = Vec2.neo(this.m_linearImpulse.x, this.m_linearImpulse.y);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            let RevoluteJoint = __webpack_require__(34);
            let PrismaticJoint = __webpack_require__(35);
            ...
            function GearJoint (def, bodyA, bodyB, joint1, joint2, ratio) {
                ...
                if (this.m_type1 === RevoluteJoint.TYPE) {
                    ...
                    let pA = Rot.mulTVec2(xfC.q, Vec2.add(Rot.mul(xfA.q, this.m_localAnchorA), Vec2.sub(xfA.p, xfC.p)));
                ...
                if (this.m_type2 === RevoluteJoint.TYPE) {
                    ...
                    let pB = Rot.mulTVec2(xfD.q, Vec2.add(Rot.mul(xfB.q, this.m_localAnchorB), Vec2.sub(xfB.p, xfD.p)));
            ...
            GearJoint.prototype.getReactionTorque = function (inv_dt) {
                let L = this.m_impulse * this.m_JwA; // float
                return inv_dt * L;
            };
            ...
            GearJoint.prototype.initVelocityConstraints = function (step) {
                ...
                let vC = this.m_bodyC.c_velocity.v;
                let wC = this.m_bodyC.c_velocity.w;

                let aD = this.m_bodyD.c_position.a;
                let vD = this.m_bodyD.c_velocity.v;
                ...
                if (this.m_type1 == RevoluteJoint.TYPE) {
                    ...
                    let rC = Rot.mulSub(qC, this.m_localAnchorC, this.m_lcC); // Vec2
                    let rA = Rot.mulSub(qA, this.m_localAnchorA, this.m_lcA); // Vec2
                    this.m_JvAC = u;
                ...
                if (this.m_type2 == RevoluteJoint.TYPE) {
                    ...
                    let rD = Rot.mulSub(qD, this.m_localAnchorD, this.m_lcD); // Vec2
                    let rB = Rot.mulSub(qB, this.m_localAnchorB, this.m_lcB); // Vec2
            ...
            GearJoint.prototype.solveVelocityConstraints = function (step) {
                ...
                let Cdot = Vec2.dot(this.m_JvAC, vA) - Vec2.dot(this.m_JvAC, vC) + Vec2.dot(this.m_JvBD, vB) - Vec2.dot(this.m_JvBD, vD); // float
            ...
            GearJoint.prototype.solvePositionConstraints = function (step) {
                ...
                let cB = this.m_bodyB.c_position.c;
                let aB = this.m_bodyB.c_position.a;
                let cC = this.m_bodyC.c_position.c;
                let aC = this.m_bodyC.c_position.a;
                let cD = this.m_bodyD.c_position.c;
                let aD = this.m_bodyD.c_position.a;
                ...
                if (this.m_type1 == RevoluteJoint.TYPE) {
                    ...
                    let pC = Vec2.sub(this.m_localAnchorC, this.m_lcC); // Vec2
                    let pA = Rot.mulTVec2(qC, Vec2.add(rA, Vec2.sub(cA, cC))); // Vec2
                ...
                if (this.m_type2 == RevoluteJoint.TYPE) {
                    ...
                    let rD = Rot.mulSub(qD, this.m_localAnchorD, this.m_lcD);
                    let rB = Rot.mulSub(qB, this.m_localAnchorB, this.m_lcB);
                    JvBD = Vec2.mul(this.m_ratio, u);
                    JwD = this.m_ratio * Vec2.cross(rD, u);
                    JwB = this.m_ratio * Vec2.cross(rB, u);
                    mass += this.m_ratio * this.m_ratio * (this.m_mD + this.m_mB) + this.m_iD * JwD * JwD + this.m_iB * JwB * JwB;

                    let pD = Vec2.sub(this.m_localAnchorD, this.m_lcD); // Vec2
                    let pB = Rot.mulTVec2(qD, Vec2.add(rB, Vec2.sub(cB, cD))); // Vec2
                    coordinateB = Vec2.dot(pB, this.m_localAxisD) - Vec2.dot(pD, this.m_localAxisD);
                }

                let C = coordinateA + this.m_ratio * coordinateB - this.m_constant; // float
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function MotorJoint (def, bodyA, bodyB) {
                ...
                let angleA = bodyA.getAngle();
                let angleB = bodyB.getAngle();
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            MouseJoint.prototype.initVelocityConstraints = function (step) {
                ...
                let position = this.m_bodyB.c_position;
                let velocity = this.m_bodyB.c_velocity;
            ...
            MouseJoint.prototype.solveVelocityConstraints = function (step) {
                let velocity = this.m_bodyB.c_velocity;
                let vB = Vec2.clone(velocity.v);
                let wB = velocity.w;

                // Cdot = v + cross(w, r)

                let Cdot = Vec2.cross(wB, this.m_rB);
                Cdot.add(vB);
                ...
                let oldImpulse = Vec2.clone(this.m_impulse);
                this.m_impulse.add(impulse);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            PulleyJoint._deserialize = function (data, world, restore) {
                data.bodyA = restore(Body, data.bodyA, world);
                data.bodyB = restore(Body, data.bodyB, world);
                let joint = new PulleyJoint(data);
                return joint;
            };
            ...
            PulleyJoint.prototype.initVelocityConstraints = function (step) {
                ...
                // Compute effective mass.
                let ruA = Vec2.cross(this.m_rA, this.m_uA); // float
                let ruB = Vec2.cross(this.m_rB, this.m_uB); // float

                let mA = this.m_invMassA + this.m_invIA * ruA * ruA; // float
                let mB = this.m_invMassB + this.m_invIB * ruB * ruB; // float
                ...
                if (step.warmStarting) {
                    ...
                    // Warm starting.
                    let PA = Vec2.mul(-this.m_impulse, this.m_uA);
                    let PB = Vec2.mul(-this.m_ratio * this.m_impulse, this.m_uB);
            ...
            PulleyJoint.prototype.solveVelocityConstraints = function (step) {
                ...
                let Cdot = -Vec2.dot(this.m_uA, vpA) - this.m_ratio * Vec2.dot(this.m_uB, vpB); // float
                let impulse = -this.m_mass * Cdot; // float
                this.m_impulse += impulse;

                let PA = Vec2.mul(-impulse, this.m_uA); // Vec2
                let PB = Vec2.mul(-this.m_ratio * impulse, this.m_uB); // Vec2
                vA.addMul(this.m_invMassA, PA);
                wA += this.m_invIA * Vec2.cross(this.m_rA, PA);
                vB.addMul(this.m_invMassB, PB);
                wB += this.m_invIB * Vec2.cross(this.m_rB, PB);
            ...
            PulleyJoint.prototype.solvePositionConstraints = function (step) {
                ...
                // Get the pulley axes.
                let uA = Vec2.sub(Vec2.add(cA, this.m_rA), this.m_groundAnchorA);
                let uB = Vec2.sub(Vec2.add(cB, this.m_rB), this.m_groundAnchorB);
                ...
                // Compute effective mass.
                let ruA = Vec2.cross(rA, uA);
                let ruB = Vec2.cross(rB, uB);
                ...
                let C = this.m_constant - lengthA - this.m_ratio * lengthB; // float
                let linearError = Math.abs(C); // float

                let impulse = -mass * C; // float

                let PA = Vec2.mul(-impulse, uA); // Vec2
                let PB = Vec2.mul(-this.m_ratio * impulse, uB); // Vec2
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            RopeJoint.prototype.initVelocityConstraints = function (step) {
                ...
                let C = this.m_length - this.m_maxLength; // float
                if (C > 0.0) {
                ...
                // Compute effective mass.
                let crA = Vec2.cross(this.m_rA, this.m_u); // float
                let crB = Vec2.cross(this.m_rB, this.m_u); // float
                let invMass = this.m_invMassA + this.m_invIA * crA * crA + this.m_invMassB + this.m_invIB * crB * crB; // float
            ...
            RopeJoint.prototype.solveVelocityConstraints = function (step) {
                ...
                // Cdot = dot(u, v + cross(w, r))
                let vpA = Vec2.addCross(vA, wA, this.m_rA); // Vec2
                let vpB = Vec2.addCross(vB, wB, this.m_rB); // Vec2
                let C = this.m_length - this.m_maxLength; // float
                ...
                let impulse = -this.m_mass * Cdot; // float
                let oldImpulse = this.m_impulse; // float
                this.m_impulse = Math.min(0.0, this.m_impulse + impulse);
                impulse = this.m_impulse - oldImpulse;

                let P = Vec2.mul(impulse, this.m_u); // Vec2
                vA.subMul(this.m_invMassA, P);
                wA -= this.m_invIA * Vec2.cross(this.m_rA, P);
                vB.addMul(this.m_invMassB, P);
                wB += this.m_invIB * Vec2.cross(this.m_rB, P);
            ...
            RopeJoint.prototype.solvePositionConstraints = function (step) {
                let cA = this.m_bodyA.c_position.c; // Vec2
                let aA = this.m_bodyA.c_position.a; // float
                let cB = this.m_bodyB.c_position.c; // Vec2
                ...
                let length = u.normalize(); // float
                let C = length - this.m_maxLength; // float

                C = Math.clamp(C, 0.0, Settings.maxLinearCorrection);

                let impulse = -this.m_mass * C; // float
                let P = Vec2.mul(impulse, u); // Vec2
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            WeldJoint.prototype.initVelocityConstraints = function (step) {
                ...
                if (this.m_frequencyHz > 0.0) {
                    ...
                    let m = invM > 0.0 ? 1.0 / invM : 0.0; // float

                    let C = aB - aA - this.m_referenceAngle; // float

                    // Frequency
                    let omega = 2.0 * Math.PI * this.m_frequencyHz; // float

                    // Damping coefficient
                    let d = 2.0 * m * this.m_dampingRatio * omega; // float

                    // Spring stiffness
                    let k = m * omega * omega; // float
            ...
            WeldJoint.prototype.solveVelocityConstraints = function (step) {
                ...
                if (this.m_frequencyHz > 0.0) {
                    ...
                    let impulse2 = -this.m_mass.ez.z * (Cdot2 + this.m_bias + this.m_gamma * this.m_impulse.z); // float
                    ...
                    let impulse1 = Vec2.neg(Mat33.mulVec2(this.m_mass, Cdot1)); // Vec2
                    ...
                    Cdot1.subCombine(1, vA, 1, Vec2.cross(wA, this.m_rA)); // Vec2
                    var Cdot2 = wB - wA; // float
                    let Cdot = Vec3(Cdot1.x, Cdot1.y, Cdot2); // Vec3

                    let impulse = Vec3.neg(Mat33.mulVec3(this.m_mass, Cdot)); // Vec3
                    this.m_impulse.add(impulse);
            ...
            WeldJoint.prototype.solvePositionConstraints = function (step) {
                ...
                if (this.m_frequencyHz > 0.0) {
                    ...
                    let C2 = aB - aA - this.m_referenceAngle; // float

                    positionError = C1.length();
                    angularError = Math.abs(C2);

                    let C = Vec3(C1.x, C1.y, C2);

                    let impulse = Vec3();
                    if (K.ez.z > 0.0) {
                        impulse = Vec3.neg(K.solve33(C));
                    } else {
                        let impulse2 = Vec2.neg(K.solve22(C1));
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            WheelJoint.prototype.getJointTranslation = function () {
                ...
                let pA = bA.getWorldPoint(this.m_localAnchorA); // Vec2
                let pB = bB.getWorldPoint(this.m_localAnchorB); // Vec2
                let d = Vec2.sub(pB, pA); // Vec2
                let axis = bA.getWorldVector(this.m_localXAxisA); // Vec2

                let translation = Vec2.dot(d, axis); // float
                return translation;
            };
            ...
            WheelJoint.prototype.initVelocityConstraints = function (step) {
                ...
                if (this.m_frequencyHz > 0.0) {
                    ...
                    let invMass = mA + mB + iA * this.m_sAx * this.m_sAx + iB * this.m_sBx * this.m_sBx; // float

                    if (invMass > 0.0) {
                        this.m_springMass = 1.0 / invMass;

                        let C = Vec2.dot(d, this.m_ax); // float
                        ...
                        // Spring stiffness
                        let k = this.m_springMass * omega * omega; // float
                ...
                if (step.warmStarting) {
                    ...
                    let P = Vec2.combine(this.m_impulse, this.m_ay, this.m_springImpulse, this.m_ax);
            ...
            WheelJoint.prototype.solvePositionConstraints = function (step) {
                ...
                let ay = Rot.mulVec2(qA, this.m_localYAxisA);

                let sAy = Vec2.cross(Vec2.add(d, rA), ay); // float
                let sBy = Vec2.cross(rB, ay); // float

                let C = Vec2.dot(d, ay); // float

                let k = this.m_invMassA + this.m_invMassB + this.m_invIA * this.m_sAy * this.m_sAy + this.m_invIB * this.m_sBy * this.m_sBy; // float
                ...
                let P = Vec2.mul(impulse, ay); // Vec2
                let LA = impulse * sAy; // float
                let LB = impulse * sBy; // float
