let IgeUiGridPanel = IgeUiElement.extend({
    ...
    _childMounted: function (obj) {
        ...
        let gridHeight = Math.floor(this._bounds2d.y / this._gridCellHeight);
        let totalChildren = this._children.length - 1; let positionX; let positionY;
